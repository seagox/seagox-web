            ...
            <el-table :data="tableData" border stripe @row-dblclick="goDetail" max-height="650" row-key="id">
                ...
                <el-table-column label="操作" align="center">
                    <template slot-scope="scope">
                        <el-button v-if="scope.row.status === 0" type="text" size="small" @click="urge(scope.row)">催办</el-button>
...
export default {
    ...
    methods: {
        ...
        queryByPage() {
            ...
            this.$axios.get('cloud/authority/querySelfItemByPage', { params }).then(res => {
        ...
        urge(row){
            ...
            this.$axios.post('cloud/authority/urge', params).then(res => {
                if (res.data.code === 200) {
