    ...
    export default {
        ...
        methods: {
            ...
            initForm() {
                ...
                this.$set(this.formModel, 'assets_off_rent.assets_id', query.assetsId)
                this.$set(this.formModel, 'assets_off_rent.assets_name', query.assetsName)
                this.$set(this.formModel, 'assets_off_rent.contract_id', query.contractId )
                this.$set(this.formModel, 'assets_off_rent.contract_code', query.contractCode)
                this.$set(this.formModel, 'assets_off_rent.rent_period', query.rentPeriod)
            },

            goDepositForm() {
                console.log('sfafaafaf', this.formModel)
                this.$history.push({
                    path: '/runCode',
                    query: {
                        id: 14, // 收款信息表
                        ...
                        openType: 'form',
                        type: 11, // 退款单
                        contract: this.formModel['assets_off_rent.contract_id'],
                        receiptsCompany: this.formModel['assets_off_rent.user_name'],
                        receiptsBank: this.formModel['assets_off_rent.bank'],
                        receiptsAccount: this.formModel['assets_off_rent.bank_account'],
