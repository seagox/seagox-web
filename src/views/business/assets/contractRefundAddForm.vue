    ...
    export default {
        ...
        methods: {
            ...
            initForm() {
                ...
                this.$set(this.formModel, 'assets_refund.receipt_id', query.receiptId + '')
                this.$set(this.formModel, 'assets_refund.user_name', query.userName)
                this.$set(this.formModel, 'assets_refund.receipt_company', query.receiptCompany )
                this.$set(this.formModel, 'assets_refund.receipt_account', query.receiptAccount)
                this.$set(this.formModel, 'assets_refund.receipt_bank', query.receiptBank)
            }
        }
    }
</script>
