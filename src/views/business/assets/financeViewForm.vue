        ...
        <div :style="{ width: approvalVisible ? 'calc(100% - 324px)' : '100%' }">
            ...
            <div style="margin-bottom: 20px">
                <el-tabs type="border-card">
                    <el-tab-pane label="房租明细" v-if="this.$history.currentRoute.query.type == '2'">
                        <el-table :data="houseBillTableForm.houseBillData" style="width: 100%">
                            ...
                            <el-table-column prop="start_date" align="center" label="开始日期"></el-table-column>
                            <el-table-column prop="end_date" align="center" label="结束日期"></el-table-column>
                            <el-table-column prop="amount" align="center" width="240" label="收款金额"></el-table-column>
                        </el-table>
                    </el-tab-pane>
                </el-tabs>
            </div>
            ...
            <div style="margin-bottom: 20px">
                <el-tabs type="border-card">
                    <el-tab-pane label="费用明细" v-if="this.$history.currentRoute.query.type == '3'">
                        <el-table :data="otherCostForm.otherCostData" style="width: 100%">
                            <el-table-column prop="typeName" align="center" label="费用类型"></el-table-column>
                            <el-table-column prop="amount" align="center" label="收款金额"></el-table-column>
                        </el-table>
                    </el-tab-pane>
                </el-tabs>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            getHouseBill() {
                ...
                this.$axios.get('cloud/entrance/queryRentDetailByInfoId', {params}).then(res => {
                    if (res.data.code == 200) {
            ...
            getOtherCost() {
                ...
                this.$axios.get('cloud/entrance/queryFeeDetailByInfoId', {params}).then(res => {
                    if (res.data.code == 200) {
