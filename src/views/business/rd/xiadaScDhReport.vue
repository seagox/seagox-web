<template>
    <div class="container xiadaScDhReport-page ">
...
<style scoped>
.xiadaScDhReport-page .searchView {
...
.xiadaScDhReport-page .el-tabs__header .el-tabs__item.is-active {
    border-bottom: 1px solid #e4e7ed;
    background: #efefef;
}
.xiadaScDhReport-page .toolView {
    margin-top: 5px;
    margin-bottom: 5px;
    padding-left: 0;
}
...
.el-main {
    border-left: 0px solid #e5e9f2 !important;
