<template>
    <div class="container importScDhReport-page">
                        ...
                        <el-row :gutter="10">
                            ...
                            <el-col :span="6">
                                <el-button
                                    ...
                                    >查询</el-button
                                >
                                <el-button type="primary" style="margin-left: 5px" @click.native="importReport"
                                    >导入报告</el-button
                                >
                            </el-col>
                        </el-row>
...
<style scoped>
.importScDhReport-page .searchView {
