<template>
    <div class="container hqReportSend-page">
        <div class="table">
            <el-tabs v-model="activeName" @tab-click="handleClick" type="card">
                <el-tab-pane label="未下达" name="first">
                    <div class="toolView">
                        <el-button style="font-size:14px" size="small" round type="plain" @click="send(0)"
                            >下达到部门</el-button
                        >
                        <el-button style="font-size:14px" size="small" round type="plain" @click="send(1)"
                            >下达到财政</el-button
                        >
                    ...
                    >
                        ...
                        <el-table-column align="center" label="发表时间" prop="spDate"></el-table-column>
                    </el-table>
                    <!--分页-->
                ...
                <el-tab-pane label="已下达" name="second">
                    ...
                    >
                        ...
                        <el-table-column align="center" label="发表时间" prop="xdDate"></el-table-column>
                    </el-table>
                    <!--分页-->
                    <div class="pagination">
                        <el-pagination
...
export default {
    ...
    methods: {
        ...
        send(flag) {
            ...
            this.$confirm(`确定要下达所选数据吗？`, '提示', { type: 'warning' }).then(() => {
                let idss = []
                for (let i = 0; i < _selectData.length; i++) {
                    idss.push(_selectData[i].id)
                }
                ...
                this.$axios.post('cloud/entrance/send', param).then(res => {
                    this.$message({
                        message: '下达成功',
                        type: 'success'
                    })
...
.hqReportSend-page .el-tabs__header .el-tabs__item.is-active {
    border-bottom: 1px solid #e4e7ed;
    background: #efefef;
}
.hqReportSend-page .toolView {
    margin-bottom: 5px;
    padding-left: 0;
}
.container {
