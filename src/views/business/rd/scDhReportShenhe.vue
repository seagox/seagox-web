            ...
            <el-main>
                ...
                <div style="border-bottom: 2px solid #e5e9f2; margin: 10px 20px">
                    <el-tabs v-model="status" @tab-click="handleClick">
                        ...
                        <el-tab-pane label="已确认" name="5"></el-tab-pane>
                    </el-tabs>
                </div>
                <div class="toolView" style="padding: 0 10px">
                    <el-button v-if="status == 3" size="mini" type="primary" @click="updateStatus(5)">确认</el-button>
                    <el-button v-if="status == 3" size="mini" type="primary" @click="updateStatus(4)">退回</el-button>
                    <el-button v-if="status == 5" size="mini" type="primary" @click="updateStatus(3)">撤销</el-button>
                ...
                <div class="table">
                    ...
                    <el-table :data="tableData" max-height="500" border stripe highlight-current-row ref="multiple">
                        ...
                        <el-table-column prop="zgTime" label="发表时间" width="160" align="center"></el-table-column>
                    </el-table>
                    <!--分页-->
