...
export default {
    ...
    methods: {
        queryByPage() {
            ...
            that.$axios.get('jellyFormDesign/queryByPage', { params }).then(res => {
        ...
        addSubmit() {
            ...
            this.$refs.addForm.validate(valid => {
                if (valid) {
                    ...
                    that.$axios.post('jellyFormDesign/insert', params).then(res => {
                        if (res.data.code == 200) {
        ...
        editSubmit() {
            ...
            this.$refs.editForm.validate(valid => {
                if (valid) {
                    ...
                    that.$axios.post('jellyFormDesign/update', params).then(res => {
                        if (res.data.code == 200) {
        ...
        deleteSubmit(row) {
            ...
            this.$confirm('亲，确认要删除吗？', '提示', { type: 'warning' }).then(() => {
                that.$axios.post('jellyFormDesign/delete/' + row.id, {}).then(res => {
                    if (res.data.code == 200) {
